...
Terraform will perform the following actions:
  ...
  + resource "google_storage_bucket" "demo-bucket" {
      ...
      + id                          = (known after apply)
      + location                    = "US"
      + name                        = "terraform-demo-412115-terra-bucket"
...
google_bigquery_dataset.demo_dataset: Creation complete after 1s [id=projects/terraform-demo-412115/datasets/demo_dataset]
google_storage_bucket.demo-bucket: Creation complete after 1s [id=terraform-demo-412115-terra-bucket]
